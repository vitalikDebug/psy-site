...
// Обновленные данные с сокращенным текстом
const bentoCards = [
  {
    id: 'photo-1',
    type: 'photo',
    src: "/photo_2025-11-28_14-57-46.jpg",
    alt: "Юлия Шкаранда",
    name: "Юлия Шкаранда",
  ...
  },
  {
    ...
    // Сделали текст короче и красивее
    text: "Работа с корнем проблемы через психологию, а не просто маскировка речевых симптомов."
  },
  {
    id: 'photo-2',
    type: 'photo',
    src: "/photo_2025-11-28_14-57-43.jpg",
    alt: "Процесс работы",
    name: "Процесс",
    role: "Индивидуальные сессии"
  },
  {
    id: 'text-2',
    type: 'text',
    title: "Опыт и экспертиза",
    text: "Более 15 лет практики и 5000+ часов работы с детьми и взрослыми."
  },
  {
    id: 'photo-3',
    type: 'photo',
    src: "/photo_2025-11-28_14-57-44.jpg",
    alt: "Детали работы",
    name: "Результат",
    role: "Свободная речь"
  },
  {
    ...
    text: "Сопровождение и ответы на вопросы в закрытом сообществе."
  }
];
