...
const reviewsData = [
  ...
  {
    id: 5,
    text: 'Если честно, брала курс уже без особых ожиданий. Думала, опять будет что-то теоретическое. Но в итоге многое пересмотрела в своём поведении. Когда сама стала спокойнее реагировать, ребёнок реально стал меньше запинаться.',
    author: 'Екатерина',
    role: 'Мама пациента',
    emoji: '👩🏽'
  },
  {
    id: 6,
    text: 'Мне зашло, что не нужно было никуда водить ребёнка. Я просто сама смотрела уроки и пробовала менять общение дома. И это дало результат, хотя сначала вообще не верилось.',
    author: 'Мария',
    role: 'Мама пациента',
    emoji: '👩🏼‍🦱'
  },
  {
    id: 7,
    text: 'Очень откликнулось про состояние родителя. Я раньше думала, что просто нужно «исправить речь», а оказалось, что я сама сильно давлю. Начала это замечать и уже от этого стало легче.',
    author: 'Оксана',
    role: 'Мама пациента',
    emoji: '👩🏻‍🦰'
  },
  {
    id: 8,
    text: 'Курс простой… И главное — понятно, что делать в жизни, а не просто послушал и забыл.',
    author: 'Дарья',
    role: 'Мама пациента',
    emoji: '👩'
  },
  {
    id: 9,
    text: 'У нас не было сильного заикания, но ребёнок зажимался, особенно когда отвечал. Сейчас стал спокойнее говорить, меньше переживает. Для меня это уже огромный результат.',
    author: 'Светлана',
    role: 'Мама пациента',
    emoji: '👱🏻‍♀️'
  },
  {
    id: 10,
    text: 'Мне понравилось, что нет ощущения «срочно исправить ребёнка». Наоборот, как-то спокойнее начинаешь к этому относиться.',
    author: 'Алина',
    role: 'Мама пациента',
    emoji: '👩🏻'
  },
  {
    id: 11,
    text: 'Сначала было сложно не вмешиваться и не поправлять. Но когда попробовала по-другому реагировать, увидела, что ребёнок сам начинает выравниваться.',
    author: 'Татьяна',
    role: 'Мама пациента',
    emoji: '👩🏽'
  },
...
export default function ReviewsSection() {
  ...
  // На телефонах мы показываем по 1 отзыву, а на компах по 2.
  // Так как мы рендерим на клиенте (используем useState), Next.js может ругаться на гидратацию, 
  // если мы будем использовать window.innerWidth.
  // Но мы можем оставить логику слайдера на 2 элемента, а на телефонах второй элемент скрывать через CSS (или перестраивать).
