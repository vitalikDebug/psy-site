...
const blogPosts = [
  ...
  // --- НОВАЯ СТАТЬЯ ---
  {
    ...
    fullText: 'Если упростить, можно выделить несколько психотипов, и у каждого из них есть не только особенности речи, но и поведения в целом.',
  },
 {
    id: 4,
    categoryId: 'faq', 
    ...
    fullText: 'Родитель остаётся с чувствами стыда, боли и растерянности. Важно вернуть себе опору и не оправдываться перед окружающими.',
  },
  {
    id: 5,
    categoryId: 'start', 
    ...
    fullText: 'Мы создаём безопасное пространство, где ребёнок может выдохнуть и перестать бояться.',
  }
];
