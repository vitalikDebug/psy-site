...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: 'С удовольствием рассказываю вам, из чего складывается та система работы, благодаря которой мои клиенты — дети, подростки и взрослые — преодолевают заикание...',
  }
];
