...
const processData = [
  ...
  },
  {
    ...
    description: 'Обучаю техникам глубокой релаксации. Вы научитесь физически расслаблять речевой аппарат, шею и тело.',
    icon: Wind,
  ...
  },
  {
    ...
    description: 'Меняем отношение к речи и к себе говорящему. Мы поэтапно снимаем страх ошибки и возвращаем веру в собственный голос.',
    icon: Brain,
  ...
  },
  {
    ...
    description: 'Отработка звонков по телефону, уверенное общение с незнакомыми людьми, подготовка к публичным выступлениям.',
    icon: Rocket,
